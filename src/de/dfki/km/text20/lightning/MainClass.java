...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		MainClass.getInstance().addToStatistic(
				"use warp: "
						+ MainClass.getInstance().getProperties().isUseWarp());
		MainClass.getInstance().addToStatistic(
				"sound activated"
						+ MainClass.getInstance().getProperties()
								.isSoundActivated());
	...
	private void init() {
		...
		FixationCatcher fixationCatcher = new FixationCatcher(
	...
	public void playError() {
		this.showTrayMessage("-- ERROR -- your eyes are not recognized!");
		if (!this.properties.isSoundActivated())
			return;
	...
	private boolean checkDll() {
		...
		if (!destination.exists()) {
			...
			String msg = new String(
					"Initializing failed. A necessary DLL-file, 'JIntellitype.dll', could not be copied into your "
							+ destination.getParent()
							+ " directory. Please do it by yourself or run Project Lightning (Desktop) with granted administration rights.");
