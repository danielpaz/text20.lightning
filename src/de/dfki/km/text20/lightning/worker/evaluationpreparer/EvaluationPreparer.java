 ...
 * MA 02110-1301  USA
 */
package de.dfki.km.text20.lightning.worker.evaluationpreparer;
...
import de.dfki.km.text20.lightning.worker.evaluationpreparer.gui.PreparerWindow;
    ...
    private void exit() {
        ...
        try {
            ...
            for (Point coordinate : this.coordinates) {
                ...
                writer.writeCharacters("" + coordinate.x);
                writer.writeEndElement();
                writer.writeCharacters("\r\n");
                writer.writeCharacters("\t\t");
                writer.writeStartElement("y");
                writer.writeCharacters("" + coordinate.y);
                writer.writeEndElement();
                writer.writeCharacters("\r\n");
                writer.writeCharacters("\t");
                writer.writeEndElement();
