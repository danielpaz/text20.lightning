        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                contentPanel.setLayout(new FormLayout(
                    ...
                    "7*(default, $lgap), 3dlu, 5*($lgap, default), $lgap, bottom:default:grow"));
                ...
                contentPanel.add(labelStemSize, cc.xywh(1, 5, 3, 1));
                contentPanel.add(spinnerStemSize, cc.xy(5, 5));
                ...
                contentPanel.add(labelMerge, cc.xywh(1, 11, 3, 1));
                contentPanel.add(checkBoxMerge, cc.xy(5, 11));

                //---- labelDelete ----
                labelDelete.setText("use delete");
                contentPanel.add(labelDelete, cc.xywh(1, 13, 3, 1));
                contentPanel.add(checkBoxDelete, cc.xy(5, 13));
                contentPanel.add(separator1, cc.xywh(1, 15, 5, 1));

                //---- labelDestinyFactor ----
                labelDestinyFactor.setText("merge_densityFactor");
                contentPanel.add(labelDestinyFactor, cc.xywh(1, 17, 3, 1));
                contentPanel.add(spinnerDestinyFactor, cc.xy(5, 17));

                //---- labelMass ----
                labelMass.setText("merge_mass");
                contentPanel.add(labelMass, cc.xywh(1, 19, 3, 1));
                contentPanel.add(spinnerMass, cc.xy(5, 19));

                //---- labelDist1 ----
                labelDist1.setText("merge_dist1");
                contentPanel.add(labelDist1, cc.xywh(1, 21, 3, 1));
                contentPanel.add(spinnerDist1, cc.xy(5, 21));

                //---- labelDistFac ----
                labelDistFac.setText("merge_distfac");
                contentPanel.add(labelDistFac, cc.xywh(1, 23, 3, 1));
                contentPanel.add(spinnerDistFac, cc.xy(5, 23));

                //---- labelDist2 ----
                labelDist2.setText("merge_dist2");
                contentPanel.add(labelDist2, cc.xywh(1, 25, 3, 1));
                contentPanel.add(spinnerDist2, cc.xy(5, 25));

                //---- buttonOK ----
                buttonOK.setText("OK");
                contentPanel.add(buttonOK, cc.xy(1, 27));

                //---- buttonDefault ----
                buttonDefault.setText("Default");
                contentPanel.add(buttonDefault, cc.xy(3, 27));

                //---- buttonCancel ----
                buttonCancel.setText("Cancel");
                contentPanel.add(buttonCancel, cc.xy(5, 27));
            }
