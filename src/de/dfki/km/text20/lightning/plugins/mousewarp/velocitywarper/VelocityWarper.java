...
public class VelocityWarper implements MouseWarper {
    ...
    public VelocityWarper() {
        ...
        this.fixation = null;
        this.information = new PluginInformation("Velocity Warper", "Uses mouse velocity to calculate warpjump. BETA", true);
        this.angleFirst = 0;
        this.angleSecLast = 0;
        this.propertie = null;
    ...
    public void addMousePosition(Point position, int interval, boolean isFixationValid) {
        ...
        this.velocity = this.mousePositions.lastEntry().getValue().distance(this.mousePositions.firstEntry().getValue()) / (this.mousePositions.size() * interval);
        ...
        // indicate warp
        System.out.println("Warp - Mouse move to (" + this.setPoint.x + "," + this.setPoint.y + ") over a distance of " + (int) this.setPoint.distance(this.mousePositions.lastEntry().getValue()) + " Pixels. Method: Advanced Warper");
