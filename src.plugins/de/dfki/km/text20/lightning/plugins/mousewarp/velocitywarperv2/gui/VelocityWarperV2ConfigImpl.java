...
public class VelocityWarperV2ConfigImpl extends VelocityWarperV2Config implements
        ActionListener {

    /** current used properties */
    private VelocityWarperV2Properties properties;

    /**
     * creates new DistanceWarperConfigImpl-object and initializes variables
     */
    public VelocityWarperV2ConfigImpl() {
        // initialize properties and preselect spinners
        this.properties = VelocityWarperV2Properties.getInstance();
        ...
        this.spinnerMaxSpeed.setModel(new SpinnerNumberModel(this.properties.getvMax(), 0.1, 2.147483647E9, 0.1));
    ...
    private void buttonDefaultActionPerformed() {
        ...
        this.spinnerReactionTime.setValue(this.properties.getReactionTime());
        this.spinnerMaxSpeed.setValue(this.properties.getvMax());
    }
    ...
    private void buttonOKActionPerformed() {
        ...
        this.properties.setvMax(Double.parseDouble(this.spinnerMaxSpeed.getValue().toString()));
        dispose();
    }
