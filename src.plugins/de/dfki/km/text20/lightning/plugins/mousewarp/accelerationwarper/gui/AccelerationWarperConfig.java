...
public class AccelerationWarperConfig extends JFrame {
    public AccelerationWarperConfig() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        labelAcceleration = new JLabel();
        spinnerAcceleration = new JSpinner();
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                //---- labelAcceleration ----
                labelAcceleration.setText("minimal Acceleration in Pixel/ms\u00b2");
                contentPanel.add(labelAcceleration, cc.xywh(1, 3, 3, 1));

                //---- spinnerAcceleration ----
                spinnerAcceleration.setModel(new SpinnerNumberModel(0.0, 0.0, 2.147483647E9, 1.0));
                spinnerAcceleration.setEnabled(false);
                contentPanel.add(spinnerAcceleration, cc.xy(5, 3));
    ...
    protected JLabel labelAcceleration;
    protected JSpinner spinnerAcceleration;
