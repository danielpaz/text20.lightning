 ...
 * MA 02110-1301  USA
 */
package de.dfki.km.text20.lightning.plugins.mousewarp.improvedSimpleWarper.gui;

import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

import de.dfki.km.text20.lightning.plugins.mousewarp.improvedSimpleWarper.ImprovedWarperProperties;
...
public class ImprovedWarperConfigImpl extends ImprovedWarperConfig implements
    ...
    private void manageToolTips() {
        ...
        String labelSetRadiusTT = "<HTML><body>If you move your mouse to your fixation point<br>and your mouse warp is activated, it will be set<br>in the chosen distance from the fixation point<br>to allow you to stop the movement by<br>yourself.</body></HTML>";
